    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white text-gray-900 font-sans">
      ...
      <header className="py-6 px-6 border-b border-gray-200">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <h1 className="text-2xl font-bold text-teal-600">ScanVerify</h1>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="md:col-span-1 hidden md:flex flex-col justify-start">
              <div className="bg-white p-8 rounded-lg shadow-sm">
                <h3 className="text-xl font-bold text-gray-800 mb-6">Why Join ScanVerify?</h3>
                
                <div className="mb-6">
                  <div className="w-12 h-12 bg-teal-100 rounded-full flex items-center justify-center mb-3">
                    <span className="text-teal-600 text-xl">✓</span>
                  </div>
                  <h4 className="font-semibold text-gray-800 mb-2">Verified Badge</h4>
                  <p className="text-sm text-gray-600">Display your verified business status to build customer trust</p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <h4 className="font-semibold text-gray-800 mb-2">Unique Code</h4>
                  <p className="text-sm text-gray-600">Get your vendor code and QR code for customer payments</p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-600">Accept verified customer payments safely through Squad</p>
                </div>

                <div className="bg-teal-50 p-4 rounded-lg border border-teal-100 mt-8">
                  <p className="text-sm text-teal-800 italic">
                    "Trusted verification and secure payment tools for modern pharmacies."
                  </p>
                </div>

                {/* Dashboard Preview */}
                <div className="mt-8 pt-8 border-t border-gray-200">
                  <h4 className="font-semibold text-gray-800 mb-4">Your Dashboard</h4>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-xs font-mono text-gray-600">VENDOR CODE</span>
                      <span className="text-sm font-bold text-gray-800">PHARM-2024</span>
                    </div>
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-xs font-mono text-gray-600">QR CODE</span>
            ...
            <div className="md:col-span-2">
              <div className="bg-white p-8 md:p-12 rounded-lg shadow-sm">
                ...
                <p className="text-gray-600 mb-8">
                  Join ScanVerify to receive your verified badge, vendor code, QR code, and payment dashboard access.
                </p>
                ...
                {isSuccess ? (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
                    ...
                    <p className="text-green-700">Your vendor account has been created. You will be redirected to login.</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 flex items-start">
                      ...
                      <p className="text-sm text-blue-800">
                        Your business and banking information is securely protected with industry-standard encryption.
                      </p>
                    </div>
                  </form>
                )}
